...
# Rails 6.0 support:
#
# source://jbuilder//lib/jbuilder/collection_renderer.rb#82
class Jbuilder::CollectionRenderer < ::ActionView::PartialRenderer
  ...
  #
  # source://jbuilder//lib/jbuilder/collection_renderer.rb#85
  def initialize(lookup_context, options, &scope); end

  # source://jbuilder//lib/jbuilder/collection_renderer.rb#91
  def render_collection_with_partial(collection, partial, context, block); end

  private

  # source://jbuilder//lib/jbuilder/collection_renderer.rb#102
  def collection_with_template(view, template); end

  # source://jbuilder//lib/jbuilder/collection_renderer.rb#96
