...
class ActionMailbox::InboundEmail < ::ActiveRecord::Base
  ...
  class << self
    ...
    # source://activerecord/6.0.6.1/lib/active_record/enum.rb#163
    def statuses; end
...
module ActionMailbox::InboundEmail::GeneratedAssociationMethods
  ...
  # source://activestorage/6.0.6.1/lib/active_storage/attached/model.rb#35
  def raw_email; end

  # source://activestorage/6.0.6.1/lib/active_storage/attached/model.rb#40
...
# source://actionmailbox//lib/action_mailbox/mail_ext/recipients.rb#3
module Mail
  class << self
...
# source://actionmailbox//lib/action_mailbox/mail_ext/recipients.rb#4
class Mail::Message
